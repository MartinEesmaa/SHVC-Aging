...
.ACCU 16
	...
	brk $47.b		; 00 47
	eor ($42.b,X)		; 41 42
	eor $5400.w,Y		; 59 00 54
	pha		; 48
	eor $20.b		; 45 20
	eor $52.b,S		; 43 52
	eor $5A.b,X		; 55 5A
	brk $4D.b		; 00 4D
	eor $41594E.l		; 4F 4E 59 41
	eor ($54.b)		; 52 54
	phy		; 5A
	jsr $4D00.w		; 20 00 4D
	eor ($52.b,X)		; 41 52
	...
	eor ($41.b,X)		; 41 41
	brk $54.b		; 00 54
	eor $0020.w,Y		; 59 20 00
	jmp $5345.w		; 4C 45 53
	phk		; 4B
	eor $48.b,X		; 55 48
	brk $41.b		; 00 41
	eor ($4E.b)		; 52 4E
	eor $20444C.l		; 4F 4C 44 20
	brk $48.b		; 00 48
	eor $4C.b		; 45 4C
	eor [$41.b]		; 47 41
	jsr $2020.w		; 20 20 20
