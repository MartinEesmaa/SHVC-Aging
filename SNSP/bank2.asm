...
.SECTION "Bank2" FORCE
	...
	brk $00.b		; 00 00
	ora [$07.b]		; 07 07
	ora $680F08.l		; 0F 08 0F 68
	ora $0000EC.l		; 0F EC 00 00
	brk $00.b		; 00 00
	brk $00.b		; 00 00
	brk $0F.b		; 00 0F
	ora [$18.b]		; 07 18
	...
	asl $28.b,X		; 16 28
	asl $00.b,X		; 16 00
	adc $08320D.l,X		; 7F 0D 32 08
	ora [$28.b]		; 07 28
	ora [$20.b],Y		; 17 20
	ora $F01E61.l,X		; 1F 61 1E F0
	...
	.db $30, $07		; 30 07
	stz $07.b,X		; 74 07
	rol $1B23.w,X		; 3E 23 1B
	eor ($3D.b,X)		; 41 3D
	.db $50, $2F		; 50 2F
	eor ($2D.b)		; 52 2D
	trb $0063.w		; 1C 63 00
	adc $060B04.l,X		; 7F 04 0B 06
	ora ($23.b,X)		; 01 23
	bit $6D.b		; 24 6D
	.db $42, $7C		; 42 7C
	stz $7E.b,X		; 74 7E
	...
	ora $3C.b,S		; 03 3C
	trb $0F.b		; 14 0F
	ora $27071F.l		; 0F 1F 07 27
	ora [$27.b]		; 07 27
	ora $D81C3F.l		; 0F 3F 1C D8
	sed		; F8
	.db $10, $F8		; 10 F8
	cpy #$4878.w		; C0 78 48
	plp		; 28
	...
	tsb $FC00.w		; 0C 00 FC
	cpx #$E0FC.w		; E0 FC E0
	jsr ($0778.w,X)		; FC 78 07
	inc $FB00.w,X		; FE 00 FB
	tsb $FF.b		; 04 FF
	ora $130060.l		; 0F 60 00 13
	jsr $5063.w		; 20 63 50
	.db $70, $98		; 70 98
	adc $AFAE7F.l,X		; 7F 7F AE AF
	.db $90, $97		; 90 97
	stx $99.b,Y		; 96 99
	adc ($7F.b,S),Y		; 73 7F
	tsb $2C2C.w		; 0C 2C 2C
	bit $4F67.w,X		; 3C 67 4F
	.db $10, $E8		; 10 E8
...
.ACCU 8
	...
	clc		; 18
	asl $1F19.w		; 0E 19 1F
	and $333010.l,X		; 3F 10 30 33
	brk $33.b		; 00 33
	brk $10.b		; 00 10
	.db $70, $1F		; 70 1F
	ora $000F16.l		; 0F 16 0F 00
	ora $03330C.l,X		; 1F 0C 33 03
	and $0C0C0C.l,X		; 3F 0C 0C 0C
	tsb $1F0F.w		; 0C 0F 1F
	.db $10, $F0		; 10 F0
...
.INDEX 8
	...
	cpx $1B.b		; E4 1B
	.db $F0, $03		; F0 03
	sbc $07FF0F.l		; EF 0F FF 07
	adc $7D45.w,X		; 7D 45 7D
	adc $38.b		; 65 38
	and $0100.w,Y		; 39 00 01
	ldy $80BC.w,X		; BC BC 80
	sta $C7B1AE.l		; 8F AE B1 C7
	sed		; F8
	eor $BA.b		; 45 BA
	stz $9B.b		; 64 9B
	dec A		; 3A
	eor [$06.b]		; 47 06
	and $38F000.l,X		; 3F 00 F0 38
	sec		; 38
	.db $F0, $F8		; F0 F8
	.db $80, $84		; 80 84
	.db $80, $9C		; 80 9C
	...
	brk $00.b		; 00 00
	brk $00.b		; 00 00
	jmp ($E662.w,X)		; 7C 62 E6
	sbc $1EFD06.l,X		; FF 06 FD 1E
	adc ($06.b),Y		; 71 06
	...
	.db $30, $13		; 30 13
	adc ($6C.b,S),Y		; 73 6C
	cmp $08E538.l,X		; DF 38 E5 08
	pea $7C00.w		; F4 00 7C
	brk $18.b		; 00 18
	brk $00.b		; 00 00
	ora $3F0C3F.l		; 0F 3F 0C 3F
	jsr $181F.w		; 20 1F 18
	...
	brk $00.b		; 00 00
	asl $1F4F.w		; 0E 4F 1F
	eor $4CFF1E.l,X		; 5F 1E FF 4C
	ldx $4C30.w,Y		; BE 30 4C
	brk $3C.b		; 00 3C
	brk $00.b		; 00 00
	brk $00.b		; 00 00
	.db $30, $7F		; 30 7F
	jsr $007F.w		; 20 7F 00
	and $303E40.l,X		; 3F 40 3E 30
	bit $0000.w,X		; 3C 00 00
	brk $00.b		; 00 00
	brk $00.b		; 00 00
	brk $15.b		; 00 15
	...
	trb $38F8.w		; 1C F8 38
	phd		; 0B
	ora $7F191F.l		; 0F 1F 19 7F
	asl $69.b		; 06 69
	.db $10, $3B		; 10 3B
	ora $063B0C.l		; 0F 0C 3B 06
	ora $0E00.w,Y		; 19 00 0E
	phd		; 0B
	trb $10.b		; 14 10
	and $465640.l		; 2F 40 56 46
	lsr $30.b,X		; 56 30
	and [$04.b]		; 27 04
	ora [$06.b]		; 07 06
	ora [$00.b]		; 07 00
	...
	cop $39.b		; 02 39
	brk $1D.b		; 00 1D
	and $06310E.l		; 2F 0E 31 06
	ora $0E00.w,Y		; 19 00 0E
	sec		; 38
	and $424443.l,X		; 3F 43 44 42
	eor $38.b		; 45 38
	rol $0310.w,X		; 3E 10 03
	asl $060F.w		; 0E 0F 06
	ora [$00.b]		; 07 00
	brk $00.b		; 00 00
	brk $E0.b		; 00 E0
	...
	brk $03.b		; 00 03
	brk $00.b		; 00 00
	ora $FFF008.l		; 0F 08 F0 FF
	sty $8B.b		; 84 8B
	rti		; 40

	eor $003931.l		; 4F 31 39 00
	ora [$00.b]		; 07 00
	ora $00.b,S		; 03 00
	brk $10.b		; 00 10
	inx		; E8
...
.INDEX 16
	...
	brk $00.b		; 00 00
	brk $1D.b		; 00 1D
	jsl $1F100F.l		; 22 0F 10 1F
	jsr $201F.w		; 20 1F 20
	rol $3841.w,X		; 3E 41 38
	lsr $60.b		; 46 60
	tya		; 98
	brk $E0.b		; 00 E0
