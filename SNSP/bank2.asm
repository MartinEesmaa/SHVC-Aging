...
.INDEX 8
	...
	brk $00.b		; 00 00
	brk $00.b		; 00 00
	and $3F3F39.l,X		; 3F 39 3F 3F
	and $080839.l,X		; 3F 39 08 08
	brk $00.b		; 00 00
	brk $00.b		; 00 00
	brk $00.b		; 00 00
	brk $00.b		; 00 00
	...
	inc $36FE.w,X		; FE FE 36
	ror $063E.w,X		; 7E 3E 06
	asl $00.b		; 06 00
	brk $00.b		; 00 00
	brk $00.b		; 00 00
	brk $1F.b		; 00 1F
	and $1F7F3F.l,X		; 3F 3F 7F 1F
	sta $00CF0F.l,X		; 9F 0F CF 00
	pea $7C00.w		; F4 00 7C
	brk $18.b		; 00 18
	brk $00.b		; 00 00
	brk $3F.b		; 00 3F
	and $7F7F04.l,X		; 3F 04 7F 7F
	and $080834.l,X		; 3F 34 08 08
	brk $00.b		; 00 00
	brk $00.b		; 00 00
	brk $00.b		; 00 00
	.db $F0, $F8		; F0 F8
	...
	ldx $4C00.w,Y		; BE 00 4C
	brk $3C.b		; 00 3C
	brk $00.b		; 00 00
	brk $00.b		; 00 00
	.db $30, $7F		; 30 7F
	jsr $007F.w		; 20 7F 00
	and $307E40.l,X		; 3F 40 7E 30
	...
	cop $03.b		; 02 03
	cop $03.b		; 02 03
	jsl $373423.l		; 22 23 34 37
	jmp $FE887E.l		; 5C 7E 88 FE
	brk $CC.b		; 00 CC
	brk $80.b		; 00 80
	sbc $00FF00.l,X		; FF 00 FF 00
	sbc $00FF00.l,X		; FF 00 FF 00
...
.INDEX 16
	...
	brk $0C.b		; 00 0C
	brk $00.b		; 00 00
	ora $38601F.l,X		; 1F 1F 60 38
	cmp [$63.b]		; C7 63
	sta $639F6C.l,X		; 9F 6C 9F 63
	...
	brk $60.b		; 00 60
	brk $00.b		; 00 00
	sbc $FA03FA.l,X		; FF FA 03 FA
	ora $00.b,S		; 03 00
	sbc $309060.l,X		; FF 60 90 30
	pha		; 48
	clc		; 18
	rol $04.b		; 26 04
	ora $3C0000.l,X		; 1F 00 00 3C
	brk $3C.b		; 00 3C
	brk $00.b		; 00 00
	brk $00.b		; 00 00
	brk $00.b		; 00 00
	...
	brk $06.b		; 00 06
	brk $00.b		; 00 00
	and $704038.l,X		; 3F 38 40 70
	sta $5F906F.l		; 8F 6F 90 5F
	ldy #$A31C.w		; A0 1C A3
	rts		; 60

	sta $00843B.l,X		; 9F 3B 84 00
	brk $07.b		; 00 07
	brk $10.b		; 00 10
	brk $20.b		; 00 20
	brk $00.b		; 00 00
	...
	sed		; F8
	brk $C6.b		; 00 C6
	.db $82, $DB, $82		; 82 DB 82
	sbc [$96.b]		; E7 96
	cmp $D0FEAC.l,X		; DF AC FE D0
	...
	brk $7C.b		; 00 7C
	sta $76.b,S		; 83 76
	sta $6C9B6E.l		; 8F 6E 9B 6C
	sta $7F8E71.l,X		; 9F 71 8E 7F
	.db $80, $3F		; 80 3F
	...
	ora ($00.b,X)		; 01 00
	ora [$00.b]		; 07 00
	and $707F30.l,X		; 3F 30 7F 70
	sbc $F0FFF0.l,X		; FF F0 FF F0
	sbc $817EE0.l,X		; FF E0 7E 81
	sbc $00FF00.l,X		; FF 00 FF 00
	...
	ora $F107F7.l,X		; 1F F7 07 F1
	ora ($00.b,X)		; 01 00
	sbc $00FF00.l,X		; FF 00 FF 00
	sbc $00FF80.l,X		; FF 80 FF 00
	and $081F00.l,X		; 3F 00 1F 08
	ora $F00F0E.l		; 0F 0E 0F F0
	.db $F0, $F0		; F0 F0
	.db $F0, $F0		; F0 F0
	.db $F0, $F0		; F0 F0
	.db $F0, $00		; F0 00
	...
	sbc $00FF00.l,X		; FF 00 FF 00
	sbc $00FF00.l,X		; FF 00 FF 00
	sbc $E21010.l,X		; FF 10 10 E2
.ACCU 8
	sep #$EE		; E2 EE
	inc $FCFC.w		; EE FC FC
	sed		; F8
	sed		; F8
	jmp ($3FFC.w,X)		; 7C FC 3F
	sbc $EFFF1F.l,X		; FF 1F FF EF
	sbc $11FF1D.l,X		; FF 1D FF 11
	...
	lsr $FF.b,X		; 56 FF
	dec A		; 3A
	sbc $571F76.l,X		; FF 76 1F 57
	and $5F3F37.l,X		; 3F 37 3F 5F
	and $635F63.l,X		; 3F 63 5F 63
	adc $679F67.l,X		; 7F 67 9F 67
	lda $73BF6B.l,X		; BF 6B BF 73
	cmp $07DF03.l,X		; DF 03 DF 07
	cmp $63DF37.l,X		; DF 37 DF 63
	cmp $6BDF67.l,X		; DF 67 DF 6B
	cmp $73DF6F.l,X		; DF 6F DF 73
	cmp $7BDF77.l,X		; DF 77 DF 7B
	cmp $67FF7F.l,X		; DF 7F FF 67
	sbc $6FFF6B.l,X		; FF 6B FF 6F
