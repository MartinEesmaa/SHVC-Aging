...
.INDEX 16
	...
	brk $FF.b		; 00 FF
	brk $00.b		; 00 00
	stz $FF88.w,X		; 9E 88 FF
	.db $90, $FF		; 90 FF
	sta ($7F.b),Y		; 91 7F
	eor #$4A7F.w		; 49 7F 4A
	adc $FFFF6A.l,X		; 7F 6A FF FF
	brk $00.b		; 00 00
	brk $00.b		; 00 00
	jmp ($EE90.w)		; 6C 90 EE
	ora ($EE.b),Y		; 11 EE
	...
	cmp ($FE.b,X)		; C1 FE
	inc $FFFF.w,X		; FE FF FF
	adc $30306F.l		; 6F 6F 30 30
	ora $C43B1F.l,X		; 1F 1F 3B C4
