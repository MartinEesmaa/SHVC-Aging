...
.SECTION "Bank2" FORCE
	...
	brk $07.b		; 00 07
	ora [$08.b]		; 07 08
	ora $EC6F68.l		; 0F 68 6F EC
	sbc $000000.l		; EF 00 00 00
	brk $00.b		; 00 00
	brk $0F.b		; 00 0F
	ora $101F18.l		; 0F 18 1F 10
	ora $F07F70.l,X		; 1F 70 7F F0
	...
	and $2F7030.l,X		; 3F 30 70 2F
	rts		; 60

	lda $80.b,S		; A3 80
	lda $80.b,S		; A3 80
	lda $80.b,S		; A3 80
	ldy $6F80.w,X		; BC 80 6F
	brk $30.b		; 00 30
	brk $26.b		; 00 26
	sbc $E51A.w,Y		; F9 1A E5
	.db $F0, $0F		; F0 0F
	ldx $E041.w,Y		; BE 41 E0
	brk $0C.b		; 00 0C
	cpx #$E00C.w		; E0 0C E0
	tsb $20E0.w		; 0C E0 20
	jsr $00C0.w		; 20 C0 00
	...
	sed		; F8
	ora [$60.b]		; 07 60
	adc $023F00.l,X		; 7F 00 3F 02
	brk $32.b		; 00 32
	jsr $233F.w		; 20 3F 23
	adc $90907F.l,X		; 7F 7F 90 90
	dey		; 88
	dey		; 88
	...
	.db $30, $F0		; 30 F0
	.db $30, $70		; 30 70
	adc $093F00.l,X		; 7F 00 3F 09
	asl $2D.b		; 06 2D
	ora ($20.b)		; 12 20
	ora $001E21.l,X		; 1F 21 1E 00
	adc $703F00.l,X		; 7F 00 3F 70
	.db $70, $0F		; 70 0F
	brk $02.b		; 00 02
	brk $32.b		; 00 32
	jsr $233F.w		; 20 3F 23
	...
	brk $0C.b		; 00 0C
	cpy #$664E.w		; C0 4E 66
	.db $62, $67, $23		; 62 67 23
	cmp [$07.b]		; C7 07
	ror $300E.w		; 6E 0E 30
	.db $30, $F0		; 30 F0
	.db $30, $7F		; 30 7F
	adc $003F30.l,X		; 7F 30 3F 00
	cop $24.b		; 02 24
	tas		; 1B
	jsr $211F.w		; 20 1F 21
	...
	.db $70, $7F		; 70 7F
	.db $30, $3F		; 30 3F
	ora $203200.l		; 0F 00 32 20
	and $3F3F23.l,X		; 3F 23 3F 3F
	brk $00.b		; 00 00
	brk $00.b		; 00 00
	jsr ($0EFC.w,X)		; FC FC 0E
	...
	brk $FC.b		; 00 FC
	tsb $00FC.w		; 0C FC 00
	inc $6266.w,X		; FE 66 62
	adc [$23.b]		; 67 23
	cmp [$07.b]		; C7 07
	ror $300E.w		; 6E 0E 30
	.db $30, $F0		; 30 F0
	.db $30, $7F		; 30 7F
	adc $043030.l,X		; 7F 30 30 04
	phd		; 0B
	and $2012.w		; 2D 12 20
	ora $001E21.l,X		; 1F 21 1E 00
	adc $703F00.l,X		; 7F 00 3F 70
	adc $02303F.l,X		; 7F 3F 30 02
	brk $32.b		; 00 32
	jsr $233F.w		; 20 3F 23
	and $00003F.l,X		; 3F 3F 00 00
	brk $00.b		; 00 00
	...
	.db $30, $74		; 30 74
	adc [$3E.b],Y		; 77 3E
	and $511B3B.l,X		; 3F 3B 1B 51
	and $2F53.w,X		; 3D 53 2F
	eor ($2D.b,S),Y		; 53 2D
	ora $0163.w,X		; 1D 63 01
	adc $387F78.l,X		; 7F 78 7F 38
	and $7E3F3C.l,X		; 3F 3C 3F 7E
	eor ($7F.b,S),Y		; 53 7F
	adc [$7F.b],Y		; 77 7F
	adc [$1F.b],Y		; 77 1F
	ora $040F1F.l,X		; 1F 1F 0F 04
	...
	brk $00.b		; 00 00
	brk $1F.b		; 00 1F
	ora $0C3F00.l,X		; 1F 00 3F 0C
	trb $7F68.w		; 1C 68 7F
	.db $90, $7F		; 90 7F
	ldy #$A07F.w		; A0 7F A0
	and $001F7F.l,X		; 3F 7F 1F 00
	ora [$07.b]		; 07 07
	tsb $0800.w		; 0C 00 08
	ora [$10.b]		; 07 10
	ora $201F20.l		; 0F 20 1F 20
	ora $1C003F.l,X		; 1F 3F 00 1C
	cpx #$00F8.w		; E0 F8 00
	sed		; F8
	cpy #$40F8.w		; C0 F8 40
	sed		; F8
	...
	ora ($FB.b,X)		; 01 FB
	ora [$FF.b]		; 07 FF
	ora $1F0F6F.l		; 0F 6F 0F 1F
	and $0F7F1F.l		; 2F 1F 7F 0F
	sbc $AE7F7F.l,X		; FF 7F 7F AE
	lda $909790.l		; AF 90 97 90
	sta $007F70.l,X		; 9F 70 7F 00
	and $007F00.l		; 2F 00 7F 00
	adc $FFEE16.l,X		; 7F 16 EE FF
	...
	ora [$3F.b]		; 07 3F
	asl $0C6F.w		; 0E 6F 0C
	adc $2C1F0C.l,X		; 7F 0C 1F 2C
	ora $0F0F3F.l,X		; 1F 3F 0F 0F
	asl $07.b		; 06 07
	brk $0F.b		; 00 0F
	and ($3F.b),Y		; 31 3F
	eor ($5E.b)		; 52 5E
	.db $62, $6E, $01		; 62 6E 01
	and $3F00.w		; 2D 00 3F
	.db $10, $E8		; 10 E8
	sed		; F8
	sed		; F8
	...
	.db $F0, $F0		; F0 F0
	cpy #$E0F8.w		; C0 F8 E0
	jsr ($9E90.w,X)		; FC 90 9E
	php		; 08
	asl $0E08.w		; 0E 08 0E
	.db $10, $1C		; 10 1C
	cpx #$10FC.w		; E0 FC 10
	ora $1F030F.l		; 0F 0F 03 1F
	brk $3F.b		; 00 3F
	brk $3F.b		; 00 3F
	brk $1F.b		; 00 1F
	brk $1F.b		; 00 1F
	...
	ora $201111.l		; 0F 11 11 20
	jsr $2020.w		; 20 20 20
	ora ($11.b),Y		; 11 11
	asl $000F.w		; 0E 0F 00
	ora $F0E810.l,X		; 1F 10 E8 F0
	.db $F0, $F8		; F0 F8
	sed		; F8
...
.INDEX 8
	...
	brk $00.b		; 00 00
	brk $3F.b		; 00 3F
	and $7F1F04.l,X		; 3F 04 1F 7F
	ora $080034.l		; 0F 34 00 08
	brk $00.b		; 00 00
	brk $00.b		; 00 00
	brk $00.b		; 00 00
	.db $F0, $F8		; F0 F8
	...
	brk $00.b		; 00 00
	brk $00.b		; 00 00
	and $1F1F08.l,X		; 3F 08 1F 1F
	ora $080C08.l,X		; 1F 08 0C 08
	brk $00.b		; 00 00
	brk $00.b		; 00 00
	brk $00.b		; 00 00
	brk $00.b		; 00 00
	...
	brk $00.b		; 00 00
	.db $F0, $30		; F0 30
	ldy $560C.w,X		; BC 0C 56
	asl A		; 0A
	jmp $2C13.w		; 4C 13 2C
	ora $20.b,S		; 03 20
	ora [$00.b]		; 07 00
	ora $C00E00.l,X		; 1F 00 0E C0
	brk $F0.b		; 00 F0
	.db $80, $74		; 80 74
	rti		; 40
	...
	cop $3F.b		; 02 3F
	and $430601.l,X		; 3F 01 06 43
	bit $3F40.w,X		; 3C 40 3F
	brk $3F.b		; 00 3F
	.db $10, $0F		; 10 0F
	brk $FD.b		; 00 FD
	brk $FD.b		; 00 FD
	and $04043F.l,X		; 3F 3F 04 04
	jmp ($7B40.w,X)		; 7C 40 7B
	rti		; 40

	brk $00.b		; 00 00
	ora $40BF10.l,X		; 1F 10 BF 40
	lda $80FC40.l,X		; BF 40 FC 80
	brk $FC.b		; 00 FC
	php		; 08
	pea $F408.w		; F4 08 F4
	brk $FC.b		; 00 FC
	...
	adc [$00.b]		; 67 00
	sbc [$00.b],Y		; F7 00
	sbc $66613F.l,X		; FF 3F 61 66
	eor $3C.b,S		; 43 3C
	rti		; 40

	and $283F00.l,X		; 3F 00 3F 28
	and [$60.b]		; 27 60
	adc [$92.b]		; 67 92
	sta $BFBF.w,Y		; 99 BF BF
	stz $14.b		; 64 14
	jmp ($7B40.w,X)		; 7C 40 7B
	rti		; 40

	brk $00.b		; 00 00
	and $00F418.l		; 2F 18 F4 00
	jsr ($FC00.w,X)		; FC 00 FC
	.db $80, $00		; 80 00
	jsr ($F408.w,X)		; FC 08 F4
	php		; 08
	...
	.db $F0, $70		; F0 70
	and [$00.b]		; 27 00
	and $3F3F00.l,X		; 3F 00 3F 3F
	ora ($06.b,X)		; 01 06
	eor $3C.b,S		; 43 3C
	.db $42, $3D		; 42 3D
	brk $3F.b		; 00 3F
	ora $270000.l		; 0F 00 00 27
	brk $3F.b		; 00 3F
	and $04043F.l,X		; 3F 3F 04 04
	jmp ($7940.w,X)		; 7C 40 79
	rti		; 40
	...
	ora ($F2.b)		; 12 F2
	and ($FC.b)		; 32 FC
	jmp ($0031.w,X)		; 7C 31 00
	and $003F00.l,X		; 3F 00 3F 00
	and $06013F.l,X		; 3F 3F 01 06
	eor $3C.b,S		; 43 3C
	rti		; 40
	...
	sbc $E7FFDB.l,X		; FF DB FF E7
	sbc $DBFFE7.l,X		; FF E7 FF DB
	...
	cpy #$07.b		; C0 07
	ora [$1F.b]		; 07 1F
	ora $713F3A.l,X		; 1F 3A 3F 71
	adc $F17F71.l,X		; 7F 71 7F F1
	sbc $FFFFF1.l,X		; FF F1 FF FF
	sbc $18E0E0.l,X		; FF E0 E0 18
	sed		; F8
	cpy $3C.b		; C4 3C
	txa		; 8A
	ror $FA.b,X		; 76 FA
	...
	tyx		; BB
	cpy $D0.b		; C4 D0
	sbc $6E7E45.l		; EF 45 7E 6E
	adc $013333.l,X		; 7F 33 33 01
	ora ($FF.b,X)		; 01 FF
	sbc $FBFFF7.l,X		; FF F7 FF FB
	sbc $7FFFFC.l,X		; FF FC FF 7F
	adc $337F7F.l,X		; 7F 7F 7F 33
	and ($01.b,S),Y		; 33 01
	ora ($FD.b,X)		; 01 FD
	ora $ED.b,S		; 03 ED
	ora ($DD.b,S),Y		; 13 DD
...
.INDEX 16
	...
	and [$06.b],Y		; 37 06
	sbc [$1C.b]		; E7 1C
	ora $00FEF0.l,X		; 1F F0 FE 00
	brk $F0.b		; 00 F0
	.db $F0, $1C		; F0 1C
	jsr ($1E06.w,X)		; FC 06 1E
	asl $1E.b		; 06 1E
	asl $1E.b		; 06 1E
	trb $F0FC.w		; 1C FC F0
	.db $F0, $00		; F0 00
	sbc $42A042.l,X		; FF 42 A0 42
	ldy #$FF00.w		; A0 00 FF
	asl $09.b		; 06 09
	tsb $1812.w		; 0C 12 18
	stz $60.b		; 64 60
	...
	lda $51A05F.l,X		; BF 5F A0 51
	ldx $AE11.w		; AE 11 AE
	eor $AE11A0.l,X		; 5F A0 11 AE
	brk $00.b		; 00 00
	ora [$00.b]		; 07 00
	brk $3F.b		; 00 3F
	brk $3F.b		; 00 3F
	...
	and $04FC00.l,X		; 3F 00 FC 04
	asl $02.b		; 06 02
	sbc $8A07FA.l,X		; FF FA 07 8A
	adc [$8A.b],Y		; 77 8A
	adc [$FA.b],Y		; 77 FA
	ora [$8A.b]		; 07 8A
	adc [$00.b],Y		; 77 00
	...
	brk $2C.b		; 00 2C
	bit $0606.w		; 2C 06 06
	ora $211F.w,Y		; 19 1F 21
	and $223F21.l,X		; 3F 21 3F 22
	rol $1C1C.w,X		; 3E 1C 1C
	brk $7F.b		; 00 7F
	and $BF7FC0.l,X		; 3F C0 7F BF
	rti		; 40

	sbc $40E040.l,X		; FF 40 E0 40
	cpx #$E040.w		; E0 40 E0
	rti		; 40
	...
	cmp $0DFF70.l		; CF 70 FF 0D
	adc ($1D.b)		; 72 1D
	jsl $0F201F.l		; 22 1F 20 0F
	.db $10, $00		; 10 00
	...
	brk $00.b		; 00 00
	ora ($AE.b),Y		; 11 AE
	ora $AE11A0.l,X		; 1F A0 11 AE
	ora ($AE.b),Y		; 11 AE
	ora $FF40A0.l,X		; 1F A0 40 FF
	...
	sta $81A5.w,Y		; 99 A5 81
	sta $4242.w,Y		; 99 42 42
	...
	cpx #$E05F.w		; E0 5F E0
	eor $BF60E0.l,X		; 5F E0 60 BF
	and $7F00FF.l,X		; 3F FF 00 7F
	brk $00.b		; 00 00
	brk $00.b		; 00 00
	brk $00.b		; 00 00
	brk $00.b		; 00 00
	...
	brk $00.b		; 00 00
	brk $00.b		; 00 00
	sbc $60817E.l,X		; FF 7E 81 60
	sta $60827C.l,X		; 9F 7C 82 60
	...
	sta $66916E.l,X		; 9F 6E 91 66
	sta $C13E.w,Y		; 99 3E C1
	brk $7E.b		; 00 7E
	brk $00.b		; 00 00
	bit $6600.w,X		; 3C 00 66
	brk $60.b		; 00 60
	...
	brk $00.b		; 00 00
	brk $00.b		; 00 00
	sbc $669966.l,X		; FF 66 99 66
	sta $817E.w,Y		; 99 7E 81
	ror $99.b		; 66 99
	ror $99.b		; 66 99
	ror $99.b		; 66 99
	brk $FF.b		; 00 FF
	...
	ror $00.b		; 66 00
	ror $00.b		; 66 00
	ror $6600.w,X		; 7E 00 66
	brk $66.b		; 00 66
	brk $66.b		; 00 66
	brk $00.b		; 00 00
	brk $00.b		; 00 00
	ror $423C.w,X		; 7E 3C 42
	clc		; 18
	bit $18.b		; 24 18
	bit $18.b		; 24 18
	bit $18.b		; 24 18
	...
	sec		; 38
	jmp ($447C.w)		; 6C 7C 44
	jmp ($7F0F.w,X)		; 7C 0F 7F
	ora $E00FFF.l,X		; 1F FF 0F E0
	asl $0EE1.w		; 0E E1 0E
	sbc $133F07.l		; EF 07 3F 13
	adc $70473B.l		; 6F 3B 47 70
	...
	and #$310A.w		; 29 0A 31
	asl A		; 0A
	and $292A.w,Y		; 39 2A 29
	rol A		; 2A
	and $3D2A.w,Y		; 39 2A 3D
	lsr A		; 4A
	and #$394A.w		; 29 4A 39
	lsr A		; 4A
	eor ($4A.b,X)		; 41 4A
	...
	tax		; AA
	eor ($AA.b,X)		; 41 AA
	eor $3DCA.w,X		; 5D CA 3D
	dex		; CA
	adc ($EA.b,X)		; 61 EA
	and #$2DEA.w		; 29 EA 2D
	nop		; EA
	and ($EA.b),Y		; 31 EA
	and $45EA.w,X		; 3D EA 45
	nop		; EA
	eor #$4DEA.w		; 49 EA 4D
	nop		; EA
	eor ($EA.b),Y		; 51 EA
	eor $EA.b,X		; 55 EA
	eor $5DEA.w,Y		; 59 EA 5D
	nop		; EA
	adc ($EA.b,X)		; 61 EA
	adc $0A.b		; 65 0A
	rol $320A.w		; 2E 0A 32
	...
	ror A		; 6A
	ror $8A.b		; 66 8A
	.db $62, $AA, $5E		; 62 AA 5E
	nop		; EA
	rol $0F.b,X		; 36 0F
	and $6F.b		; 25 6F
	and #$318F.w		; 29 8F 31
	lda $45CF39.l		; AF 39 CF 45
	sbc $4A0F49.l		; EF 49 0F 4A
	ora $4E2F6A.l		; 0F 6A 2F 4E
	and $524F6E.l		; 2F 6E 4F 52
	eor $626F6E.l		; 4F 6E 6F 62
	lda $6ACF6A.l		; AF 6A CF 6A
	sbc $630F66.l		; EF 66 0F 63
	and $299347.l		; 2F 47 93 29
	sta ($35.b,S),Y		; 93 35
	sta ($45.b,S),Y		; 93 45
	ora ($3A.b,S),Y		; 13 3A
	ora ($4A.b,S),Y		; 13 4A
	...
	cli		; 58
	adc $193219.l		; 6F 19 32 19
	lsr $6219.w		; 4E 19 62
	sbc $F94E.w,Y		; F9 4E F9
	.db $62, $59, $6B		; 62 59 6B
	adc $3A77.w,Y		; 79 77 3A
	and ($3A.b)		; 32 3A
	rol $5A3A.w,X		; 3E 3A 5A
	phx		; DA
	eor ($3A.b)		; 52 3A
	adc $7A.b,S		; 63 7A
	adc ($7A.b,S),Y		; 73 7A
	...
	adc ($9D.b,S),Y		; 73 9D
	and #$369D.w		; 29 9D 36
	sta $FD52.w,X		; 9D 52 FD
	lsr $FD.b		; 46 FD
	phy		; 5A
	eor $BD5B.w,X		; 5D 5B BD
	adc ($5E.b,S),Y		; 73 5E
	and #$5D5E.w		; 29 5E 5D
	rol $3E2E.w,X		; 3E 2E 3E
	eor ($3E.b)		; 52 3E
	ror $BE.b		; 66 BE
	rol $52BE.w		; 2E BE 52
	ldx $FE6E.w,Y		; BE 6E FE
	lsr A		; 4A
	asl $3E53.w,X		; 1E 53 3E
	tad		; 5B
	lsr $7E5F.w,X		; 5E 5F 7E
	tad		; 5B
	stz $BE5F.w,X		; 9E 5F BE
	adc ($DE.b,S),Y		; 73 DE
	rtl		; 6B

	dec $DE77.w,X		; DE 77 DE
	tda		; 7B
	dec $7F7F.w,X		; DE 7F 7F
	and #$56DF.w		; 29 DF 56
	sbc $76FF3A.l,X		; FF 3A FF 76
	ora $373F57.l,X		; 1F 57 3F 37
	and $633F5F.l,X		; 3F 5F 3F 63
	eor $677F63.l,X		; 5F 63 7F 67
	sta $6BBF67.l,X		; 9F 67 BF 6B
	lda $03DF73.l,X		; BF 73 DF 03
	cmp $37DF07.l,X		; DF 07 DF 37
	cmp $67DF63.l,X		; DF 63 DF 67
	cmp $6FDF6B.l,X		; DF 6B DF 6F
	cmp $77DF73.l,X		; DF 73 DF 77
	cmp $7FDF7B.l,X		; DF 7B DF 7F
	sbc $6BFF67.l,X		; FF 67 FF 6B
	sbc $73FF6F.l,X		; FF 6F FF 73
	sbc $7BFF77.l,X		; FF 77 FF 7B
	sbc $37777F.l,X		; FF 7F 77 37
	and $10.b,S		; 23 10
	cmp $1C.b,X		; D5 1C
	.db $D0, $32		; D0 32
	cmp $9626.w,Y		; D9 26 96
	eor $1A2631.l		; 4F 31 26 1A
	...
	tsa		; 3B
	cmp ($59.b),Y		; D1 59
	stz $9547.w,X		; 9E 47 95
	rol A		; 2A
	.db $B0, $18		; B0 18
	inc A		; 1A
	tsa		; 3B
	tyx		; BB
	and $2937.w,Y		; 39 37 29
	ror $20.b		; 66 20
	asl $1335.w		; 0E 35 13
	and #$7393.w		; 29 93 73
	sbc $09607F.l,X		; FF 7F 60 09
	ldy $01.b		; A4 01
	inx		; E8
	ora ($2C.b,X)		; 01 2C
	cop $91.b		; 02 91
	...
	adc $0039CE.l,X		; 7F CE 39 00
	brk $18.b		; 00 18
	adc $36.b,S		; 63 36
	adc $FC7F99.l,X		; 7F 99 7F FC
	adc $FF7393.l,X		; 7F 93 73 FF
	adc $200000.l,X		; 7F 00 00 20
	ora $62.b,S		; 03 62
	eor $EC.b		; 45 EC
	...
	sbc $00007F.l,X		; FF 7F 00 00
	ora [$28.b],Y		; 17 28
	ora $452940.l,X		; 1F 40 29 45
	lda $1059.w		; AD 59 10
	ror $93.b		; 66 93
	adc $7FFF.w,X		; 7D FF 7F
	brk $00.b		; 00 00
	ora [$28.b],Y		; 17 28
	ora $7D8840.l,X		; 1F 40 88 7D
	eor $767E.w		; 4D 7E 76
	adc $FF7393.l,X		; 7F 93 73 FF
	adc $710000.l,X		; 7F 00 00 71
	ora $1E9B.w		; 0D 9B 1E
	adc $635F3B.l,X		; 7F 3B 5F 63
	asl $1C.b,X		; 16 1C
	ora $1F18.w		; 0D 18 1F
	.db $30, $44		; 30 44
	eor ($C8.b,X)		; 41 C8
	eor $76F0.w,Y		; 59 F0 76
	asl $5F01.w		; 0E 01 5F
	asl $FF.b,X		; 16 FF
	ora $93.b,S		; 03 93
	adc ($FF.b,S),Y		; 73 FF
	adc $CE0000.l,X		; 7F 00 00 CE
	and $5294.w,Y		; 39 94 52
	clc		; 18
	adc $9C.b,S		; 63 9C
	adc ($00.b,S),Y		; 73 00
	ror $7393.w,X		; 7E 93 73
	sbc $00007F.l,X		; FF 7F 00 00
	jsr $1603.w		; 20 03 16
	brk $1F.b		; 00 1F
	brk $7F.b		; 00 7F
	...
	and ($7E.b),Y		; 31 7E
	lda [$00.b],Y		; B7 00
	and $739302.l,X		; 3F 02 93 73
	sbc $00007F.l,X		; FF 7F 00 00
	jsr $8003.w		; 20 03 80
	ora $F1.b,S		; 03 F1
	ora $FF03F9.l,X		; 1F F9 03 FF
	eor $FF7393.l		; 4F 93 73 FF
	adc $110000.l,X		; 7F 00 00 11
	brk $17.b		; 00 17
	brk $1F.b		; 00 1F
	brk $B7.b		; 00 B7
	brk $3F.b		; 00 3F
	...
	.db $10, $40		; 10 40
	plb		; AB
	sbc $A3BAFA.l,X		; FF FA BA A3
	tax		; AA
	ldx $FFAB.w		; AE AB FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $EEDFFD.l,X		; FF FD DF EE
	tda		; 7B
	sbc $FF77FF.l,X		; FF FF 77 FF
	adc $DD7F.w,X		; 7D 7F DD
	adc [$7F.b],Y		; 77 7F
	...
	stz $E6.b,X		; 74 E6
	tax		; AA
	sbc $EBBABF.l,X		; FF BF BA EB
	inc $75BF.w,X		; FE BF 75
	sbc $FFFFFF.l,X		; FF FF FF FF
	...
	sbc $BEFFFB.l,X		; FF FB FF BE
	lda $FFABFB.l		; AF FB AB FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	...
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $EFAFFF.l,X		; FF FF AF EF
	sbc $FFBAFB.l,X		; FF FB BA FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	...
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FEFEAF.l		; EF AF FE FE
	sbc $FFEBAE.l		; EF AE EB FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	...
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FAFFFF.l,X		; FF FF FF FA
	sbc $BABEFE.l		; EF FE BE BA
	sbc $FFFF9B.l		; EF 9B FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	...
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $BFFFFF.l,X		; FF FF FF BF
	sbc $AEB3BF.l		; EF BF B3 AE
	sbc $FDAFAB.l,X		; FF AB AF FD
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	cmp $BDFFFB.l,X		; DF FB FF BD
	sbc $FFFFFF.l,X		; FF FF FF FF
	...
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $7FEFED.l,X		; FF ED EF 7F
	ldx $FFAF.w,Y		; BE AF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	xce		; FB
	sbc $FFFFFF.l,X		; FF FF FF FF
	...
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFDFF.l,X		; FF FF FD FF
	sbc $AFFAFF.l,X		; FF FF FA AF
	sbc $EFFFBF.l		; EF BF FF EF
	...
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $B96BEF.l,X		; FF EF 6B B9
	xba		; EB
	lda $FAAFF7.l		; AF F7 AF FA
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	tda		; 7B
	...
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $ABBFFF.l,X		; FF FF BF AB
	sbc $6BBFBF.l,X		; FF BF BF 6B
	xce		; FB
	lda $FFFFFF.l,X		; BF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	...
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	lda $BBFFFF.l,X		; BF FF FF BB
	lda $BFFAFF.l,X		; BF FF FA BF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFE.l,X		; FF FE FF FF
	sbc $BFFFFF.l,X		; FF FF FF BF
	...
	lda $FBFFFF.l		; AF FF FF FB
	sbc $FFAFFE.l,X		; FF FE AF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	lda $FFFEFE.l,X		; BF FE FE FF
	...
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFF.w,X		; FD FF FF
	sbc $FFFBCA.l,X		; FF CA FB FF
	sbc $FFAEFA.l,X		; FF FA AE FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFF.l,X		; FF FF FF FF
	sbc $FFFFFE.l,X		; FF FE FF FF
	...
	brk $00.b		; 00 00
	brk $00.b		; 00 00
	.db $00		; Opcode 00 overrunning bank boundry at 017FFF. Skipping.
.ENDS
