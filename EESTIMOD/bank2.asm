...
.SECTION "Bank2" FORCE
	...
	brk $00.b		; 00 00
	cpy #$C0FF.w		; C0 FF C0
	sbc $94E39C.l,X		; FF 9C E3 94
	sbc $9C.b,S		; E3 9C
	sbc $80.b,S		; E3 80
	sbc $007F00.l,X		; FF 00 7F 00
	and $EF00F3.l,X		; 3F F3 00 EF
	brk $A3.b		; 00 A3
	brk $AB.b		; 00 AB
	php		; 08
	lda $00.b,S		; A3 00
	...
	.db $30, $0E		; 30 0E
	brk $00.b		; 00 00
	and $2D0609.l,X		; 3F 09 06 2D
	ora ($20.b)		; 12 20
	ora $001E21.l,X		; 1F 21 1E 00
	adc $3F3F00.l,X		; 7F 00 3F 3F
	brk $3F.b		; 00 3F
	brk $02.b		; 00 02
	brk $32.b		; 00 32
	jsr $233F.w		; 20 3F 23
	...
	tsb $681C.w		; 0C 1C 68
	ora $E03FF0.l,X		; 1F F0 3F E0
	and $7F3FE0.l,X		; 3F E0 3F 7F
	...
	ora $7F4E79.l,X		; 1F 79 4E 7F
	pha		; 48
	and $1F003F.l,X		; 3F 3F 00 1F
	...
	eor ($90.b),Y		; 51 90
	pla		; 68
	sta $00606F.l,X		; 9F 6F 60 00
	and $00600F.l,X		; 3F 0F 60 00
	adc $7F7F8F.l,X		; 7F 8F 7F 7F
	sbc $97FFAE.l,X		; FF AE FF 97
	.db $F0, $9F		; F0 9F
	adc $2F007F.l,X		; 7F 7F 00 2F
	ora $7F007F.l,X		; 1F 7F 00 7F
	asl $EE.b,X		; 16 EE
	ora $0000FF.l,X		; 1F FF 00 00
	sbc $0D33E3.l,X		; FF E3 33 0D
	cmp ($BE.b,X)		; C1 BE
	eor ($3E.b,X)		; 41 3E
.INDEX 8
	sep #$DC		; E2 DC
	...
	brk $3F.b		; 00 3F
	asl $0162.w		; 0E 62 01
	ror $130D.w,X		; 7E 0D 13
	jsr $3F1F.w		; 20 1F 3F
	ora $06070F.l		; 0F 0F 07 06
	ora $3F310F.l		; 0F 0F 31 3F
	eor $6E635E.l,X		; 5F 5E 63 6E
	ora $002D.w		; 0D 2D 00
	and $38E810.l,X		; 3F 10 E8 38
	sed		; F8
	cpx #$00.b		; E0 00
	stz $086E.w,X		; 9E 6E 08
	.db $F0, $0E		; F0 0E
	inc $10.b,X		; F6 10
	cpx #$F8.b		; E0 F8
	trb $F0F0.w		; 1C F0 F0
...
.INDEX 8
	...
	.db $F0, $8F		; F0 8F
	sbc $FFCFBF.l,X		; FF BF CF FF
	sbc $FF00FF.l,X		; FF FF 00 FF
	adc $3F067F.l,X		; 7F 7F 06 3F
	ldy #$00.b		; A0 00
	sed		; F8
	sed		; F8
	brk $00.b		; 00 00
	...
	brk $00.b		; 00 00
	brk $00.b		; 00 00
	jsr ($F6E2.w,X)		; FC E2 F6
	sbc $F9C6.w,Y		; F9 C6 F9
	lsr $0661.w,X		; 5E 61 06
	...
	brk $00.b		; 00 00
	brk $20.b		; 00 20
	ora $9F677F.l		; 0F 7F 67 9F
	and [$CF.b],Y		; 37 CF
	php		; 08
	pea $7C00.w		; F4 00 7C
	brk $18.b		; 00 18
	brk $00.b		; 00 00
	ora $00303F.l,X		; 1F 3F 30 00
	clc		; 18
	rts		; 60
	...
	brk $00.b		; 00 00
	jsr ($FCFC.w,X)		; FC FC FC
	inc $FD82.w,X		; FE 82 FD
	ldx $0EC1.w,Y		; BE C1 0E
	ora ($06.b),Y		; 11 06
	ora #$00.b		; 09 00
	asl $00.b		; 06 00
	brk $00.b		; 00 00
	...
	ora $800F60.l,X		; 1F 60 0F 80
	brk $C0.b		; 00 C0
	ora $600960.l		; 0F 60 09 60
	brk $30.b		; 00 30
	brk $1C.b		; 00 1C
	cop $0D.b		; 02 0D
	brk $1F.b		; 00 1F
